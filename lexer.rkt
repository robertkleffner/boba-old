...
(define (tokenize ip)
  ...
  (define boba-lexer
    (lexer-src-pos
     ...
     ["modify" (token "modify" lexeme)]
     ["noun" (token "noun" lexeme)]
     ["pronoun" (token "pronoun" lexeme)]
     ["adverb" (token "adverb" lexeme)]
     ["with" (token "with" lexeme)]
     ["derive" (token "derive" lexeme)]
     ["adjective" (token "adjective" lexeme)]
     ["synonym" (token "synonym" lexeme)]
     ["verb" (token "verb" lexeme)]
